...
class Instance {
    ...
    private native int nativeCall(long instancePointer, String exportName, Object[] arguments) throws RuntimeException;
    ...
    public int call(String exportName, Object[] arguments) throws RuntimeException {
